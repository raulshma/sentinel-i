  ...
  return (
    <div className="pointer-events-auto absolute right-3 top-3 z-10 flex flex-col items-end gap-2">
      ...
      >
        ...
        Filters
        {hasActiveFilters && (
          <span className="rounded-full bg-sky-500/80 px-1.5 py-0.5 text-[9px] font-bold text-white">
      ...
      {isOpen && (
        <div className="glass-panel w-64 p-4 space-y-4 animate-in fade-in-0 zoom-in-95 duration-150">
            ...
            <div className="flex gap-1">
              {TIME_OPTIONS.map((option) => (
                <button
                  ...
                  className={`flex-1 rounded-md px-2 py-1.5 text-[11px] font-medium transition-all duration-150 ${
                    hours === option.value
